...
local function HandleGuildCommand(cmd, whisperTo)
    ...
    if cmd == "help" then
        ...
        GG_Send("!레벨 - 레벨별 목록", whisperTo)
        GG_Send("!직업 - 직업별 현황", whisperTo)
        GG_Send("!종족 - 종족별 현황", whisperTo)
        GG_Send("!인던 - 던전 입장 현황", whisperTo)
        GG_Send("!지역 - 지역별 현황", whisperTo)
        GG_Send("!전문기술 - 전문기술별 현황", whisperTo)
...
SlashCmdList["MYGREETING"] = function(msg)
    ...
    if lower == "help" or lower == "" then
        ...
        GG_Send("/mg 레벨 - 레벨별 목록", L)
        GG_Send("/mg 직업 - 직업별 현황", L)
        GG_Send("/mg 종족 - 종족별 현황", L)
        GG_Send("/mg 인던 - 던전 입장 현황", L)
        GG_Send("/mg 지역 - 지역별 현황", L)
        GG_Send("/mg 전문기술 - 전문기술별 현황", L)
